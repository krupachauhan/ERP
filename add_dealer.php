                                    ...
                                    <div class="col-lg-12">
                                        <div class="card m-b-20">
                                            <div class="card-body">
                                                ...
                                                <h4 class="mt-0 header-title">Add Dealer</h4>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">View Banner</h4>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    $fe_banner = mysqli_query($con,"select * from users where type='dealer' order by id desc ");
                                                    $no = 0;
                                                    while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                                        ...
                                                        <tr class="delete_mem<?php echo $id ?>">
                                                            ...
                                                            <td>
                                                                <div>
                                                                <a href="update_dealer.php?uid=<?php echo 
