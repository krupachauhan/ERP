                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                                <button id="add" class="btn btn-primary">Add Poster</button>
                                            <!-- <h4 class="mt-0 header-title">Add Poster</h4> -->
                                <div class="add">
                                            <form method="POST" action="action/add_vposter.php"  enctype="multipart/form-data">
            ...
            <div class="col-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">View Poster</h4>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php 
                                $fe_banner = mysqli_query($con,"select * from extra_video  order by id desc ");
                                $no = 0;
                                while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                    ...
                                    <tr class="delete_mem<?php echo $id ?>">
                                       ...
                                       <td>
                                            <div>
                                                <a href="upd_vposter.php?uid=<?php echo 
                                    ...
                                    <td>
                                        <?php echo $video;?>
                                        <!--<img src="upload/extra_video/<?php echo $image;?>" style="height:80px;width: 80px;">-->
                                        </td>
                             </tr> 
                         <?php }?>                                                  
                     </tbody>
...
<!--<div class="col-md-4"><div class="form-group"><label>Is Politicle</label><select class="form-control select2" name="isp[]" required=""><option value="">Select</option><option value="yes">Yes</option><option value="no">No</option></select></div></div>-->
