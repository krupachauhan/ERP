...
$sel = mysqli_query($con,"select * from image where idate='$date' ");
                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="action/upd_image.php?uid=<?php echo $uid; ?>&date=<?php echo $date; ?>"  enctype="multipart/form-data">
