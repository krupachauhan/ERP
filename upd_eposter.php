...
$uid = $_GET['uid'];
$sel = mysqli_query($con,"select * from extra_poster where id='$uid' ");
                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="action/upd_eposter.php?uid=<?php echo $uid; ?>"  enctype="multipart/form-data">
                                             ...
                                             <div class="col-md-2">
                                                  ...
                                                  <div class="col-md-3">
                                                           <img id="thumb" src="upload/extra_poster/<?php echo $sj['image']; ?>" alt=""  style="width:80px;height:80px;">
                                                       </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                       <div class="form-group">
                                        ...
                                        <a href="add_eposter.php" class="btn btn-secondary waves-effect">
                                            Cancel
                                        </a>
