            ...
            <div class="content">
                ...
                <ul class="list-inline menu-left mb-0">
                    ...
                    <li class="hide-phone list-inline-item app-search">
                        <h3 class="page-title">Add Frame</h3>
                    </li>
                </ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="action/add_frame.php"  enctype="multipart/form-data">
                ...
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php 
                                $fe_banner = mysqli_query($con,"select * from frame  order by id desc ");
                                $no = 0;
                                while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                    ...
                                    <tr class="delete_mem<?php echo $id ?>">
                                        ...
                                        <td>
                                            <div>
                                                <a href="update_frame.php?uid=<?php echo 
                                     ...
                                     <td><?php echo $r_banner['type']; ?></td>
                                    <!--<td><?php echo $r_banner['logo_pos']; ?></td>-->
                                    <!--<td><?php echo $r_banner['img_posi']; ?></td>-->
                                    <td><img src="upload/frame/<?php echo $image;?>" style="height:80px;width: 80px;"></td>
                             </tr> 
                         <?php }?>                                                  
                     </tbody>
                 </table>
