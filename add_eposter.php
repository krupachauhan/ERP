                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <button class="btn btn-primary" id="add">Add Eposter</button>

                                            <!-- <h4 class="mt-0 header-title">Add Poster</h4> -->
        <div class="add">

                                            <form method="POST" action="action/add_eposter.php"  enctype="multipart/form-data">
            ...
            <div class="col-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">View Frame</h4>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php 
                                $fe_banner = mysqli_query($con,"select * from extra_poster  order by id desc ");
                                $no = 0;
                                while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                    ...
                                    <tr class="delete_mem<?php echo $id ?>">
                                       ...
                                       <td>
                                            <div>
                                                <a href="upd_eposter.php?uid=<?php echo 
                                    ...
                                    <td><?php echo $r_banner['cat_id']; ?></td>
                                    <td><?php echo $r_banner['text_clr']; ?></td>
                                    <td><?php echo $r_banner['frm_clr']; ?></td>
                                    <td><img src="upload/extra_poster/<?php echo $image;?>" style="height:80px;width: 80px;"></td>
                             </tr> 
                         <?php }?>                                                  
                     </tbody>
                 </table>
