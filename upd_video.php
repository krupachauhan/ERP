...
$sel = mysqli_query($con,"select * from video where idate='$date' ");
                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="action/upd_video.php?uid=<?php echo $uid; ?>&date=<?php echo $date; ?>"  enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="cal_date" class="form-control" value="<?php echo $date; ?>">   
...
while($sj = mysqli_fetch_array($sel)){
...
<input type="hidden" name="ids[]" class="form-control" value="<?php echo $sj['id']; ?>">
                                             ...
                                             <div class="col-md-3">
                                                  ...
                                                  <div class="col-md-3">
                                                           <span id="thumb" src="upload/img/<?php echo $sj['video']; ?>" alt=""  style="width:80px;height:80px;"></span>
                                                       </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                       <div class="form-group">
                                        ...
                                        <a href="add_video.php" class="btn btn-secondary waves-effect">
                                            Cancel
                                        </a>
