            ...
            <div class="col-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">View Image</h4>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                $fe_banner = mysqli_query($con,"select * from image group by idate order by id desc ");
                                $no = 0;
                                while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                    ...
                                    <!--   <td>-->
                                    <!--        <div>-->
                                    <!--            <a href="upd_image.php?uid=<?php echo $r_banner['id'];?>"><i class="fa fa-edit fa-2x" style="color: grey ;"></i>-->
                                    <!--        </a>-->
                                    <!--        <a id="<?php echo $r_banner['id']; ?>" style="margin-left: 3px;"  class="red delete"><i class="fa fa-trash fa-2x" style="color: red ;"></i>-->
                                    <!--        </a>-->
                                    <!--    </div>-->
                                    <!--</td> -->
                                    <td><a href="add_image.php?date=<?php echo $r_banner['idate']; ?>"><?php echo date('d-m-Y',strtotime($r_banner['idate'])); ?></a></td>
