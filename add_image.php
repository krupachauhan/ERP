...
<body class="fixed-left">
 ...
 <button id="add" class="btn btn-primary">Add Image</button>
                                            
                                            <div class="add">
                                             <h4 class="mt-0 header-title">Add Poster</h4> 

                                            <form method="POST" action="action/add_image.php"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php 
                                // $date = $_GET['date'];
                                $fe_banner = mysqli_query($con,"select * from image  order by id desc ");
                                // $fe_banner = mysqli_query($con,"select * from image where idate='$date'  order by id desc ");
                                $no = 0;
                                while($r_banner = mysqli_fetch_array($fe_banner)){ 
                                    ...
                                    <tr class="delete_mem<?php echo $id ?>">
                                       ...
                                       <td>
                                            <div>
        <!--<a href="upd_image.php?uid=<?php echo $r_banner['id'];?>"><i class="fa fa-edit fa-2x" style="color: grey ;"></i></a>-->
        
        <a href="upd_image.php?uid=<?php echo $r_banner['id'];?>&date=<?php echo $r_banner['idate']; ?>"><i class="fa fa-edit fa-2x" style="color: grey ;"></i></a>
                                    ...
                                    <td><img src="upload/img/<?php echo $image;?>" style="height:80px;width: 80px;"></td>
                             </tr> 
                         <?php }?>                                                  
                     </tbody>
                 </table>
