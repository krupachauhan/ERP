            ...
            <div class="content">
                ...
                <ul class="list-inline menu-left mb-0">
                    ...
                    <li class="hide-phone list-inline-item app-search">
                        <h3 class="page-title">Add Extra Poster</h3>
                    </li>
                </ul>
...
$uid = $_GET['uid'];
$sel = mysqli_query($con,"select * from extra_video where id='$uid' ");
                                ...
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="action/upd_vposter.php?uid=<?php echo $uid; ?>"  enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cat" class="form-control" value="<?php echo $sj['cat_id']; ?>">   
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <div data-color-format="rgb" data-color="<?php echo $sj['text_clr']; ?>" class="colorpicker-default input-group">
                                                 ...
                                                 <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div data-color-format="rgb" data-color="<?php echo $sj['frm_clr']; ?>" class="colorpicker-default input-group">
                                                            <input type="text" value="#000" class="form-control" name="fclr1" value="<?php echo $sj['frm_clr']; ?>">
                                                            <span class="input-group-append add-on">
                                                                <button class="btn btn-light" type="button">
                                                                    <i style="background-color: rgb(124, 66, 84);margin-top: 2px;"></i>
                                                                </button>
                                             ...
                                             <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name='banner1' class="form-control" onchange="readThumb(this, 'thumb-error')" class="" accept="video/*">
                                                  ...
                                                  <div class="col-md-3">
                                                      <?php echo $sj['video']; ?>
                                                           <!--<img id="thumb" src="upload/extra_video/<?php echo $sj['video']; ?>" alt=""  style="width:80px;height:80px;">-->
                                                       </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                       <div class="form-group">
                                        ...
                                        <a href="add_vposter.php" class="btn btn-secondary waves-effect">
                                            Cancel
                                        </a>
...
<!--<div class="col-md-4"><div class="form-group"><label>Is political</label><select class="form-control select2" name="isp[]" required=""><option value="">Select</option><option value="yes">Yes</option><option value="no">No</option></select></div></div> <div cl-->
...
<script type="text/javascript">
    $(document).ready(function(){                    
        ...
        $("#add_more").click(function(){
            i++;
            $(".all_more").after('<div id="row'+i+'" class="all"><hr/><div class="row"> <div class="col-md-2"><div class="form-group"><label>Text Color</label><div data-color-format="rgb" data-color="" class="colorpicker-default input-group"><input type="text" value="#000" class="form-control" name="tclr[]"><span class="input-group-append add-on"><button class="btn btn-light" type="button"><i style="background-color: rgb(124, 66, 84);margin-top: 2px;"></i></button></span></div></div></div><div class="col-md-2"><div class="form-group"><label>Frame Color</label><div data-color-format="rgb" data-color="" class="colorpicker-default input-group"><input type="text" value="#000" class="form-control" name="fclr[]"><span class="input-group-append add-on"><button class="btn btn-light" type="button"><i style="background-color: rgb(124, 66, 84);margin-top: 2px;"></i></button></span></div></div></div> <div class="col-md-2"><div class="form-group"><label>Language</label><select class="form-control select2" name="lga[]"><option value="hindi">Hindi</option><option value="gujarati">Gujarati</option><option value="english">English</option></select></div></div><div class="col-md-2"><div class="form-group"><label>Select Frame image</label><input type="file" name="banner[]" class="form-control" onchange="readThumb(this, "thumb-error")" class="" accept="video/*"><div id="thumb-error" style="color: red; margin: 10px 0px 0 10px;">Please upload file having extensions .mp4 only.</div></div></div><div id="thumb" class="col-md-2"></div><div class="form-group col-md-2"><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove">X</button></div></div></div>');
