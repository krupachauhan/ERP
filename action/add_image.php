...
$uid = $_GET['uid'];
 ...
 for($j=0;$j<count($tclr);$j++)
 {
 	...
 	$insert = mysqli_query($con,"insert into image set name='$name[$j]',idate='$cal_date',text_clr='$tclr[$j]',frm_clr='$fclr[$j]',image='$ImageName',language='$lga[$j]',is_poli='$isp[$j]' ");
...
if($insert>0)
{
	...
	// </script>";
	echo "<script>alert('Image added successfully.');
